Feature: Play and choose from multiple tutorials
  ...
  Background: Populate tutorials 
    ...
    | title                   | description                                 | charityA_title | charityB_title | tutorial | show_results
    | Tutorial                | 'This is the tutorial for the Giving Game'  | Charity A      | Charity B      | true     | true
    | Tutorial 2              | 'This is another tutorial!'                 | Charity 1      | Charity 2      | true     | true
